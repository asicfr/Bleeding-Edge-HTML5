/*
    speakBufferGenerator - hacked speak.js client to generated sound ArrayBuffer instead of directly playing sound.
 */
...
function generateSoundBuffer(text, args) {
    ...
    function playHTMLAudioElement(wav) {
        ...
        var b64 = encode64(wav);
        var soundBuffer = b64a.decode(b64);
        bufferPromise.resolve(soundBuffer);
    }
